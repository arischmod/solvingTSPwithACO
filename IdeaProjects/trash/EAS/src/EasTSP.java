...
public class EasTSP {
    ...
    Runs the main loop
    */
    public EasTSP(int m, String city_choice, int local, int a, int b, int o, int nn, int iterations) {
        int i;
        this.m=m;
          //this.local=local;
          this.alpha=a;
    ...
    */
    public void ReadInstance(String fileName)
    {
        ...
        getLogger(EasTSP.class.getName()).log(Level.SEVERE, null, ex);  }
    }
...
public void ComputeNearestNeighborLists()
{
    ...
    */
    public void Evaporate()
    {
            ...
            for (int i=0; i<n; i++) {
                for (int j=i; j<n; j++) {
                    pheromone[i][j] = (1.0-p) * pheromone[i][j];//+0.1E-100;
    ...
    */
    public void DepositPheromone(int k)
    {
        ...
        for (i=0; i<n; i++) {
            ...
            /*for (s=0; s<n; s++) {
                if ((j==eliteAnt.getTourCity(s) && l==eliteAnt.getTourCity(s+1)) || (l==eliteAnt.getTourCity(s) && j==eliteAnt.getTourCity(s+1))) {
                    pheromone[j][l] = pheromone[j][l]+e/(double)bestTourLength;
                        pheromone[l][j] = pheromone[j][l];
                }
            } */
        }
    ...
    */
    public static void main(String[] args)
    {
        ...
        EasTSP demo = new EasTSP(m,city_choice, local, a, b, o, nn, iterations);
